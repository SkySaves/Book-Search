        ...
        do {
            ...
            // If the user chooses to add a book to the database
                ...
                try {
                    ...
                    //This is asking the user for a choice. If the user enters 2, the program calls the function addBook(). The function addBook() is inside a try-catch block which catches exceptions if any occur during the execution of the function.
                }
            }
            else if (choice == 3) {
                system("CLS");
                ...
                //This is asking the user for a choice. If the user enters 3, the program enters a loop that displays a list of choices related to the reading list.The user can add books to the list, remove books from the list, display the list, or return to the main menu. The functions addToList(), removeFromList(), and displayList() are called according to the user's choice. After each choice, the function readBooks() is called.
            }
            else if (choice == 4) {
                return 0;
                //This is asking the user for a choice. If the user enters 4, the program returns 0, which exits the program. If the user enters anything else, a message is displayed and the user is prompted to try again.
            }
            else {
                cout << "Invalid choice. Try again." << endl;
                cin.ignore();
